...
<body class="<?php print $classes; ?>">
  <div id="container">
    ...
    <?php if ($leaderboard): ?>
	  ...
	  <div id="clock"><div id="time"><?=$dateTime->format("g:i A");echo "<input id='servertime' type='hidden' value='".$dateTime->format('U')."' />";?> </div>&nbsp;-  Hawaii</div>
	  </div> <!-- /leaderboard -->
    <?php endif; ?>
    ...
    <div id="columns"><div class="columns-inner clearfix">
		<?php if ($left): ?>
			<div id="sidebar-first" class="sidebar brick"><?php print $left; ?></div> <!-- /sidebar-first -->
		<?php endif; ?>
		<div id="kona-girl"></div>
		<div id="seperation"><a href="mailto:sales@southkonafarms.com"></a></div>
      <div id="content-column">
	  <?php if ($right): ?>
        <div id="sidebar-last" class="sidebar brick"><?php print $right; ?></div> <!-- /sidebar-last -->
      <?php endif; ?>
	  <div class="content-inner front-page">
        ...
        <div id="main-content">
          ...
          <?php if ($title or $tabs): ?>
            <div id="main-content-header">
              <?php if ($title): ?><h1 id="page-title" class="home-page"><?php print $title; ?></h1><?php endif; ?>
              <?php if ($tabs): ?>
